  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center space-x-2 mb-6">
        ...
        <h1 className="text-2xl font-bold">Prepare for {exam.title}</h1>
      </div>

      <div className="border border-gray-200 rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-2">Exam Details</h2>
          <p className="text-gray-500 mb-4">{exam.subject} • {exam.teacher}</p>
            ...
            <div>
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="font-medium">{exam.questionCount} questions</div>
                </div>
              </div>
            </div>
            <div>
      ...
      <div className="w-full">
        <div className="flex border-b border-gray-200 mb-4">
          <button
            ...
            className={`px-4 py-2 font-medium text-sm ${activeTab === 'topics' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Topics to Study
          </button>
          <button
            onClick={() => setActiveTab('resources')}
            className={`px-4 py-2 font-medium text-sm ${activeTab === 'resources' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Study Resources
          </button>
          <button
            onClick={() => setActiveTab('practice')}
            className={`px-4 py-2 font-medium text-sm ${activeTab === 'practice' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Practice Tests
          </button>
        </div>
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-500 mb-4">Focus on these topics for the exam</p>
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-500 mb-4">Resources to help you prepare</p>
                <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-500 mb-4">Take these tests to assess your preparation</p>
                <div className="space-y-4">
                    ...
                    <div key={test.id} className="border p-4 rounded-lg hover:border-blue-500 transition-colors">
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{test.questionsCount} questions • {test.estimatedTime}</p>
                        </div>
