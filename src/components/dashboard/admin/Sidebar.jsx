...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-white fixed">
      {/* Mobile Menu Button */}
      <div className="fixed top-4 left-[50%] z-40 lg:hidden">
        <button
        ...
        <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full z-10">
          ...
          <div className="flex-1 overflow-auto py-4 px-3 text-black">
            <div className="flex flex-col gap-1">
              ...
              <NavItem to="/dashboard/admin/exam" icon={FileText} label="Examinations" />
              <NavItem to="/dashboard/admin/student" icon={UserCog} label="student" />
              <NavItem to="/dashboard/admin/setting" icon={UserCog} label="settings" />
