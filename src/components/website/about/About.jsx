      ...
      <section className="py-10 bg-gray-50 dark:bg-gray-800">
        <div className=" px-4 mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 rounded-lg p-8 shadow-md text-center">
        ...
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">10+</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Exams Completed</p>
            </div>
          </div>
        </div>
      </section>
