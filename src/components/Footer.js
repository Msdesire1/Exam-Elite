...
export default function Footer() {
  return (
    <div>
   <div>
<footer className="bg-gray-100/50 border-t py-12  border-gray-300">
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t mt-12 pt-6 flex flex-col md:flex-row justify-between items-center border-gray-300">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} Exam Elite. All rights reserved.
            </p>
